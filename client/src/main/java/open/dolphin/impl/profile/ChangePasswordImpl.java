...
//s.oh$
            ...
            userPassword1.addActionListener((ActionEvent e) -> userPassword2.requestFocus());
            
            userPassword2 = createPassField(10, null, null, null);
            userPassword2.addActionListener((ActionEvent e) -> sn.requestFocus());
            ...
            sn.addActionListener((ActionEvent e) -> givenName.requestFocus());
            sn.addFocusListener(AutoKanjiListener.getInstance());
            
            // 名
            givenName = createTextField(10, null, null, dl);
            givenName.addActionListener((ActionEvent e) -> userPassword1.requestFocus());
            ...
            // OK Btn
            ActionListener al = (ActionEvent e) -> changePassword();
        ...
        private void changePassword() {
            ...
            // 120 秒
            int maxEstimation = Integer.parseInt(bundle.getString("task.default.maxEstimation"));
            // 300 mmsec
            int delay = Integer.parseInt(bundle.getString("task.default.delay"));
