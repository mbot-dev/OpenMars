...
public class AddUserImpl extends AbstractMainTool implements AddUser {
    ...
    protected class FacilityInfoPanel extends JPanel {
        ...
        public FacilityInfoPanel() {
            ...
            updateBtn.addActionListener((ActionEvent e) -> update());
            
            clearBtn = new JButton(bundle.getString("actionText.revert"));
            clearBtn.setEnabled(false);
            clearBtn.addActionListener((ActionEvent e) -> get());

            JButton closeBtn = new JButton(bundle.getString("actionText.close"));
            closeBtn.addActionListener((ActionEvent e) -> stop());
    ...
    protected class UserListPanel extends JPanel {
        ...
        public UserListPanel() {
            ...
            // ユーザテーブル
            tableModel = new ListTableModel<>(columns, 0) {
            ...
            JButton getButton = new JButton(bundle.getString("actionText.listUsers"));
            getButton.setEnabled(true);
            //getButton.setMnemonic('L');
            getButton.addActionListener((ActionEvent e) -> getUsers());
            
            deleteButton = new JButton(bundle.getString("actionText.delete"));
            deleteButton.setEnabled(false);
            //deleteButton.setMnemonic('D');
            deleteButton.addActionListener((ActionEvent e) -> deleteUser());
            deleteButton.setToolTipText(bundle.getString("toolTipText.deleteBtn"));

            JButton cancelButton = new JButton(bundle.getString("actionText.close"));
        ...
        private void getUsers() {
            ...
            worker = new SimpleWorker<List<UserModel>, Void>() {
                ...
                protected List<UserModel> doInBackground() throws Exception {
                    ...
                    return (ArrayList<UserModel>) udl.getAllUser();
                }
...
//s.oh$
    ...
    protected class AddUserPanel extends JPanel {
        ...
        public AddUserPanel() {
            ...
            String idPassPattern = ClientContext.getString("addUser.pattern.idPass");
...
//s.oh$
            uid.addActionListener((ActionEvent e) -> view.getUserPassword1().requestFocus());
            ...
            userPassword1.addActionListener((ActionEvent e) -> view.getUserPassword2().requestFocus());
            ...
            userPassword2.addActionListener((ActionEvent e) -> view.getSn().requestFocus());
            
            JTextField sn = view.getSn();
            sn.addFocusListener(AutoKanjiListener.getInstance());
            sn.getDocument().addDocumentListener(dl);
            sn.addActionListener((ActionEvent e) -> view.getGivenName().requestFocus());
            ...
            givenName.addActionListener((ActionEvent e) -> view.getEmailField().requestFocus());
            ...
            emailField.addActionListener((ActionEvent e) -> view.getMayakuField().requestFocus());
            ...
            mayaku.addActionListener((ActionEvent e) -> view.getUid().requestFocus());
            ...
            ActionListener al = (ActionEvent e) -> addUserEntry();
            java.util.ResourceBundle bundle = ClientContext.getMyBundle(AddUserImpl.class);
        ...
        private void addUserEntry() {
            ...
            String sb = facilityId + IInfoModel.COMPOSITE_KEY_MAKER +
                    userId;
            user.setUserId(sb);
