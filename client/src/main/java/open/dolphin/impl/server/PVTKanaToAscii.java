...
//		return CString( "" );
    ...
    public String CHGKanatoASCII(String strKana, String strASCII) {
        ...
        StringBuilder strCHG = new StringBuilder();
        boolean bTrue;
        int nLen;
        ConvData dic;
        ...
        for (nLen = 0; nLen < strKana.length(); nLen++) {
            ...
            if (nLen + 1 < strKana.length()) {
                ...
                for (ConvData convData : m_DataAry) {
                    dic = convData;
                    if (dic.m_sKana.equals(strSub)) {
                        strCHG.append(dic.m_sAsc);
                        bTrue = true;
                        break;
                    }
                }
        ...
        byte[] ChgByte = strCHG.toString().getBytes();
