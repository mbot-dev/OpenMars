...
//s.oh$
    ...
    public void parseBody(Element body) {
        ...
        for (Object child : children) {
            ...
            Element moduleItem = (Element) child;
            ...
            switch (attr) {
                case patientInfo:
                    ...
                    // 患者モジュールをパースする
                    //-----------------------
                    Logger.getLogger(this.getClass().getName()).fine("patientInfo　をパース中");
                ...
                case healthInsurance:
                    ...
                    Logger.getLogger(this.getClass().getName()).fine("healthInsurance　をパース中");
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "HealthInsurance UUID = {0}", uuid);
                ...
                case e_claim:
                    ...
                    // 受付情報をパースする
                    //------------------------------
                    Logger.getLogger(this.getClass().getName()).fine("claim　をパース中");
...
//s.oh$
                    ...
                    break;
                default:
                    Logger.getLogger(this.getClass().getName()).log(Level.WARNING, "Unknown attribute value : {0}", attr);
                    break;
            }
        }
    }
        ...
        for (Object value : children) {
            ...
            switch (qname) {
                case mmlCm_Id:
                    ...
                    Logger.getLogger(this.getClass().getName()).fine("patientId = " + pid);
                ...
                case mmlNm_Name: {
                    ...
                    for (Object o : attrs) {
                        ...
                        if (attr.getName().equals(repCode)) {
                            ...
                            Logger.getLogger(this.getClass().getName()).log(Level.FINE, "curRepCode = {0}", attr.getValue());
                        } else if (attr.getName().equals(tableId)) {
                            Logger.getLogger(this.getClass().getName()).log(Level.FINE, "tableId = {0}", attr.getValue());
                        }
                    }
                ...
                case mmlNm_family:
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "family = {0}", child.getTextTrim());
                ...
                case mmlNm_given:
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "given = {0}", child.getTextTrim());
                ...
                case mmlNm_fullname:
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "fullName = {0}", child.getTextTrim());

                    break;
                case mmlPi_birthday:
                    patientModel.setBirthday(child.getTextTrim());
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "birthday = {0}", child.getTextTrim());

                    break;
                case mmlPi_sex:
                    patientModel.setGender(child.getTextTrim());
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "gender = {0}", child.getTextTrim());
                ...
                case mmlAd_Address: {
                    ...
                    for (Object o : attrs) {
                        ...
                        if (attr.getName().equals(addressClass)) {
                            ...
                            Logger.getLogger(this.getClass().getName()).log(Level.FINE, "addressClass = {0}", attr.getValue());
                        } else if (attr.getName().equals(tableId)) {
                ...
                case mmlAd_full:
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "address = {0}", child.getTextTrim());

                    break;
                case mmlAd_zip:
                    curAddress.setZipCode(child.getTextTrim());
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "zip = {0}", child.getTextTrim());
                ...
                case mmlPh_area: {
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "area = {0}", val);
                ...
                case mmlPh_city: {
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "city = {0}", val);
                ...
                case mmlPh_number: {
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "number = {0}", val);
                ...
                case mmlPh_memo:
                    ...
                    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "memo = {0}", child.getTextTrim());
                    break;
            }
    ...
    private void parseHealthInsurance(Element docInfo, Element content) {
        ...
        if (publicInsuranceEle != null) {
            ...
            for (Object child : children) {
                ...
                Element publicInsuranceItem = (Element) child;
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "priority = {0}", curPublicItem.getPriority());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "providerName = {0}", curPublicItem.getProviderName());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "provider = {0}", curPublicItem.getProvider());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "recipient = {0}", curPublicItem.getRecipient());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "startDate = {0}", curPublicItem.getStartDate());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "expiredDate = {0}", curPublicItem.getExpiredDate());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "paymentRatio = {0}", curPublicItem.getPaymentRatio());
                Logger.getLogger(this.getClass().getName()).log(Level.FINE, "paymentRatioType = {0}", curPublicItem.getPaymentRatioType());
            }
        }
    }
