...
public class SchemaEditorImpl implements SchemaEditor {
    ...
    private BufferedImage createImage() {
        ...
        try {
            ...
            drawingList.stream().forEach((d) -> d.draw(g2));
    ...
    private void initComponentsUneditable() {
        ...
        view = new SimpleCanvas(null, ClientContext.getFrameTitle(TITLE), true);
        ...
        if (extRef != null) {
            ...
            if (text != null && (!text.equals(""))) {
                view.getRoleCombo().setSelectedItem(text);
            }
        }
    ...
    private void initComponents() {
        ...
        selectBtn.addActionListener((ActionEvent e) -> stateMgr.startSelect());
        
        lineBtn.addActionListener((ActionEvent e) -> stateMgr.startLine());
        
        rectBtn.addActionListener((ActionEvent e) -> stateMgr.startRect());
        
        ellipseBtn.addActionListener((ActionEvent e) -> stateMgr.startEllipse());

        openPathBtn.addActionListener((ActionEvent e) -> stateMgr.startOpenPath());
        
        polygonBtn.addActionListener((ActionEvent e) -> stateMgr.startPolygon());
        
        rectFillBtn.addActionListener((ActionEvent e) -> stateMgr.startRectFill());
        
        ellipseFillBtn.addActionListener((ActionEvent e) -> stateMgr.startEllipseFill());
        
        polygonFillBtn.addActionListener((ActionEvent e) -> stateMgr.startPolygonFill());
        
        textBtn.addActionListener((ActionEvent e) -> stateMgr.startText());
        
        colorBtn.addActionListener((ActionEvent e) -> chooseColor());
        
        undoBtn.addActionListener((ActionEvent e) -> stateMgr.undo());
        
        clearBtn.addActionListener((ActionEvent e) -> stateMgr.clear());
