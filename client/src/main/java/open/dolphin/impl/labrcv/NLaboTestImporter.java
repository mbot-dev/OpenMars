...
//masuda$    
    ...
    public NLaboTestImporter() {
        ...
        String NAME = bundle.getString("title.labReceiver");
    ...
    public void openKarte() {
        ...
        if (showReceiptMessage) {
            ...
            cb.addActionListener((ActionEvent e) -> Project.setBoolean("showReceiptMessage", !cb.isSelected()));
...
//s.oh$
                    ...
                    // Table 更新
                    Runnable awt = () -> getTableModel().fireTableDataChanged();
        ...
        view.getTable().addMouseListener(new MouseAdapter() {
            ...
            private void mabeShowPopup(MouseEvent e) {
                ...
                if (e.isPopupTrigger()) {
                    ...
                    Object obj = getTableModel().getObject(row);
