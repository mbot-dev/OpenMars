...
//s.oh$     
    ...
    private void initialize() {
        ...
        saveBtn.addActionListener((ActionEvent e) -> save());
    ...
    private JComponent createComponent() {
        ...
        // 患者情報テーブルを生成する
        // テーブルモデル
        PatientInfoTableModel pModel = new PatientInfoTableModel(patient, PATIENT_ATTRS, COLUMN_NAMES);
...
//minagawa^ 排他制御            
            ...
            boolean ret = false;
            if (col == 1) {
                for (int editableRow : EDITABLE_ROWS) {
                    if (row == editableRow) {
                        ret = true;
                        break;
                    }
