...
public final class OrderHistoryPanel extends JPanel implements PropertyChangeListener {
    ...
    public OrderHistoryPanel() {
        ...
        // 各行は ModuleModel
        tModel = new ListTableModel<>(columnNames, startNumRows) {
            ...
            private void mabeShowPopup(MouseEvent e) {
                if (e.isPopupTrigger()) {
                    ...
                    item2.addActionListener(e1 -> {
                        ...
                        ModuleModel m1 = tModel.getObject(row);
                        if (m1 != null && (m1.getModel() instanceof BundleDolphin)) {
                            BundleDolphin bd = (BundleDolphin) m1.getModel();
        ...
        JScrollPane cs = new JScrollPane(contents,
                JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
                JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        Dimension contentSize = new Dimension(240, 300);
    ...
    public void setModuleList(List allModules) {
        ...
        for (Object allModule : allModules) {
            List<ModuleModel> l = (List<ModuleModel>) allModule;
            if (l != null) {
                for (ModuleModel moduleModel : l) {
