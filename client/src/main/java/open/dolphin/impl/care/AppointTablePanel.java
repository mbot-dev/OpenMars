    ...
    public AppointTablePanel(JButton updateBtn) {
        ...
        careTable = new JTable(tableModel) {
            ...
            public TableCellRenderer getCellRenderer(int row, int col) {
                ...
                AppointmentModel e = tableModel.getObject(row);
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        switch (prop) {
            case CareMapDocument.CALENDAR_PROP:
                ...
                for (SimpleCalendarPanel calendar : calendars) {

                    ArrayList<AppointmentModel> results = calendar.getAppointDays();
                    int size = results.size();
                    for (AppointmentModel result : results) {
                        list.add(result);
                    }
                }
