...
//masuda$
        ...
        // Adjust cut & try
        Dimension dim = new Dimension(columnWidth * 7, rowHeight*8 + 7);  // +10
...
//minagawa$        
    ...
    public void setAppointmentList(ArrayList list) {
        ...
        int size = list.size();
        for (Object o : list) {
            AppointmentModel ae = (AppointmentModel) o;
    ...
    public static class SimpleCalendarPool {
        ...
        public synchronized void releaseSimpleCalendar(SimpleCalendarPanel c) {
            ...
            ArrayList pool = poolDictionary.computeIfAbsent(key, k -> new ArrayList<>(5));
            pool.add(c);
        }
    }
}