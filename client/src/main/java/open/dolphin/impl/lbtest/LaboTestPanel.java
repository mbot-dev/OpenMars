...
//        searchLaboTest(firstResult);
    ...
    private void createAndShowGUI() {
        JDialog dialog = new JDialog(new JFrame(), pname + "（" + pkana + "）：" + pid, true);
...
//        task.execute();
        try {
            ...
            why.append(Objects.requireNonNullElse(cause, ex).getMessage());
...
//s.oh$
        ...
        // ***ラボテストの印刷***
        JButton printBtn = new JButton(buttonText);
