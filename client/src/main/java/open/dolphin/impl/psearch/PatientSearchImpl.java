...
//s.oh$
    ...
    private void connect() {
        ...
        // 自動IME ボタン
        view.getAutoIme().addActionListener(e -> {
        ...
        // Sort アイテム
        view.getSortItem().addItemListener(e -> {
...
//minagawa^ 仮保存カルテ取得対応
        view.getTmpKarteButton().addActionListener(e -> getTmpKarte());
//minagawa$
    ...
    class EventAdapter implements ActionListener, ListSelectionListener, MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2) {
                ...
                ListTableModel<PatientModel> tableModel = getTableModel();
                PatientModel value = tableModel.getObject(table.getSelectedRow());
                if (value != null) {
                    openKarte();
                }
            }
    ...
    private void find(String text) {
        ...
        SimpleWorker worker = new SimpleWorker<Collection, Void>() {
            ...
            protected Collection doInBackground() throws Exception {
                ...
                return pdl.getPatients(searchSpec);
            }
...
//s.oh$
    ...
    private void sortList(List<PatientModel> list) {
        ...
        if (!sorted) {
            ...
            switch (sortItem) {
                case 0:
                    Comparator c = (Comparator<PatientModel>) (o1, o2) -> o1.getPatientId().compareTo(o2.getPatientId());
                    list.sort(c);
                    break;
                case 1:
                  Comparator c2 = (Comparator<PatientModel>) (p1, p2) -> {
                      String kana1 = p1.getKanaName();
                      String kana2 = p2.getKanaName();
                      if (kana1 != null && kana2 != null) {
                          return p1.getKanaName().compareTo(p2.getKanaName());
