...
//s.oh$
        ...
        Cursor eraserCursor = ShapeIconMaker.createIconCursor(SchemaEditorProperties.ICON_ERASER);

        // ボタン設定
        // ツールボタン
        JToggleButton pencilBtn = toolView.getPencilBtn();
        JToggleButton eraserBtn = toolView.getEraserBtn();
        JToggleButton ovalBtn = toolView.getOvalBtn();
        JToggleButton ovalFillBtn = toolView.getOvalFillBtn();
        JToggleButton rectBtn = toolView.getRectBtn();
        JToggleButton rectFillBtn = toolView.getRectFillBtn();
        JToggleButton polyBtn = toolView.getPolyBtn();
        JToggleButton polyFillBtn = toolView.getPolyFillBtn();
        JToggleButton textBtn = toolView.getTextBtn();
        JToggleButton lineBtn = toolView.getLineBtn();
        JToggleButton selectBtn = toolView.getSelectBtn();

        JToggleButton clippingBtn = toolView.getClippingBtn();
        JToggleButton netSparseBtn = toolView.getNetSparseBtn();
        JToggleButton netMediumBtn = toolView.getNetMediumBtn();
        JToggleButton netDenseBtn = toolView.getNetDenseBtn();
        JToggleButton dotsSparseBtn = toolView.getDotsSparseBtn();
        JToggleButton dotsMediumBtn = toolView.getDotsMediumBtn();
        JToggleButton dotsDenseBtn = toolView.getDotsDenseBtn();
        ...
        // その他のボタン
        JButton undoBtn = toolView.getUndoBtn();
        undoBtn.setEnabled(false);
        JButton redoBtn = toolView.getRedoBtn();
        redoBtn.setEnabled(false);
        JButton clearBtn = toolView.getClearBtn();
        clearBtn.setEnabled(editable);
        JButton rotateRightBtn = toolView.getRotateRightBtn();
        JButton rotateLeftBtn = toolView.getRotateLeftBtn();
        JButton expandBtn = toolView.getExpandBtn();
        JButton cancelBtn = canvasView.getCancelBtn();
        JButton okBtn = canvasView.getOkBtn();
        okBtn.setSelected(editable);
        ...
        colorBtn.addActionListener((ActionEvent e) -> chooseColor());
        ...
        JTextField titleFld = canvasView.getTitleFld();
        titleFld.setText(SchemaEditorProperties.DEFAULT_TITLE);
        titleFld.setEnabled(editable);

        JComboBox roleCombo = canvasView.getRoleCombo();
