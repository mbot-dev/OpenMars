    ...
    protected void tryLogin() {
        ...
        worker = new SimpleWorker<UserModel, Void>() {
            ...
            protected UserModel doInBackground() throws Exception {
                ...
                return userDlg.login(fid, uid, password);
            }
            ...
            protected void succeeded(UserModel userModel) {
                if (userModel != null) {   
                    ...
                    String sb = time + ":" +
                            userModel.getUserId() + bundle.getString("text.hasLoggedIn");
                    java.util.logging.Logger.getLogger(this.getClass().getName()).info(sb);
...
//minagawa$        
    ...
    private void connect() {
        ...
        userIdField.addActionListener((ActionEvent e) -> stateMgr.onUserIdAction());
        ...
        passwdField.addActionListener((ActionEvent e) -> stateMgr.onPasswordAction());
    }
