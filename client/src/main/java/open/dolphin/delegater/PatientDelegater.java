...
//s.oh$
    ...
    public PatientModel getPatientById(String pid) throws Exception {
        ...
        return getEasyJson(ID_RESOURCE, PatientModel.class);
    }
    ...
    public int updatePatient(PatientModel patient) throws Exception {
        ...
        // PUT
        String entityStr = putEasyJson(BASE_RESOURCE, data, String.class);
    ...
    public List getTmpKarte() throws Exception {
        ...
        // GET
        PatientList list = getEasyJson(TMP_KARTE_RESOURCE, PatientList.class);
...
//s.oh^ 2014/07/22 一括カルテPDF出力
    public List<PatientModel> getAllPatient() throws Exception {
        ...
        // GET
        PatientList list = getEasyJson(ALL_PATIENTS_RESOURCE, PatientList.class);
