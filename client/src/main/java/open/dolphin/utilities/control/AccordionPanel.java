...
public class AccordionPanel extends JScrollPane {
    ...
    public AccordionPanel() {
        ...
        acdListener = e -> verticalBox.revalidate();
    ...
    public void openPanel(String title) {
        for(int i = 0; i < verticalBox.getComponentCount(); i++) {
            ...
            if(comp instanceof AccordionPartPanel) {
...
class AccordionPartPanel extends JPanel {
    ...
    public AccordionPartPanel(String title, Component comp) {
        ...
        Color COLOR_TITLE_TEXT = Color.BLACK;
        Color COLOR_BODY_BACKGROUND = Color.GRAY;
    ...
    public void changeStatePanel() {
        ...
        revalidate();
        execAccordionEvent();
        EventQueue.invokeLater(() -> partPanel.scrollRectToVisible(partPanel.getBounds()));
    }
    ...
    public void execAccordionEvent() {
        ...
        for (Object o : list) {
            AccordionListener listener = (AccordionListener) o;
...
interface AccordionListener{
     ...
     * @param e イベント
     */
    void accordionStateChanged(AccordionEvent e);
}
