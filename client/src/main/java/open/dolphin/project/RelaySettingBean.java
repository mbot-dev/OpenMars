...
public final class RelaySettingBean extends AbstractSettingBean {
    ...
    public boolean isValidBean() {
        boolean mmlOk = !isSendMml() || notEmpty(getMmlDirectory());
        boolean pdfOk = !isSendKartePdf() || notEmpty(getKartePdfDirectory());
        boolean relayOk = !isPvtRelay() || notEmpty(getPvtRelayDirectory());
