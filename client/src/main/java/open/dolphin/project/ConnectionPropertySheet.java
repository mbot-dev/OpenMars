...
//minagawa^ 評価アカウント作成
            ...
            if (ClientContext.isI18N()) {
                ...
                button.addActionListener((ActionEvent e) -> make5TestAccount());
...
//minagawa$            
    ...
    public void make5TestAccount() {
        ...
        PropertyChangeListener pl = (PropertyChangeEvent evt) -> newAccount((ServerInfo) evt.getNewValue());
