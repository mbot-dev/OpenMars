...
//minagawa^ LSC Test
        ...
        DBTask task = new DBTask<LetterModule,Void>(getContext()) {
            ...
            protected void succeeded(LetterModule lm) {
                ...
                chart.addChartDocument(editor, ClientContext.getMyBundle(MedicalCertificateViewer.class).getString("modify") + "(" + editor.getTitle() + ")");
            }
        };
        task.execute();
//minagawa$        
    ...
    public void copyDocument() {
        ...
        DBTask task = new DBTask<LetterModule,Void>(getContext()) {
            ...
            protected void succeeded(LetterModule lm) {
                ...
                editor.start();
                ChartImpl chart = (ChartImpl)getContext();
                chart.addChartDocument(editor, ClientContext.getMyBundle(MedicalCertificateViewer.class).getString("dupuricate") + "(" + editor.getTitle() + ")");
            }
        };
        task.execute();
    }
