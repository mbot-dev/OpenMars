...
public class LetterView extends Panel2 {
    ...
    private void initComponents() {
        ...
        JLabel lbl_title = new JLabel("診療情報提供書（フォーム）", JLabel.CENTER);
        JLabel lbl_date = new JLabel("年月日:");
        JLabel lbl_consultHosp = new JLabel("紹介先医療機関名:");
        JLabel lbl_consultDept = new JLabel("紹介先診療科:");
        JLabel lbl_consultDr = new JLabel("紹介先先生:");
        JLabel lbl_ptName = new JLabel("患者氏名:");
        JLabel lbl_ptBirthDay = new JLabel("生年月日:");
        JLabel lbl_diagnosis = new JLabel("傷病名:");
        JLabel lbl_purpose = new JLabel("紹介目的:");
        JLabel lbl_history = new JLabel("既往歴/家族歴:");
        JPanel pnl_clinicalCourse = new JPanel();
        ...
        JLabel lbl_medication = new JLabel("現在の処方:");
        JLabel lbl_remarks = new JLabel("備考:");
        JLabel lbl_ptSex = new JLabel("性別:");
        JLabel lbl_ptAge = new JLabel("年齢:");
