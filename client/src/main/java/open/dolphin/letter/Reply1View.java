...
public class Reply1View extends Panel2 {
    ...
    private void initComponents() {
        ...
        JLabel lbl_title = new JLabel("紹介患者経過報告書（フォーム）", JLabel.CENTER);
        atesakiLbl = new JLabel("先生　御机下");
        confirmed = new JLabel("年月日");
        JLabel lbl_clientHosp = new JLabel("紹介元医療機関:");
        JLabel lbl_clientTantou = new JLabel("担当:");
        JLabel lbl_clientDept = new JLabel("科");
        JLabel lbl_ptName = new JLabel("患者氏名:");
        JLabel lbl_ptBirthday = new JLabel("生年月日:");
        JLabel lbl_visitedDate = new JLabel("受診年月日:");
        JLabel lbl_setsumei = new JLabel("拝見し、下記のとおり説明いたしました。");
        JLabel lbl_thanks = new JLabel("ご紹介戴き、ありがとうございました。取り急ぎ返信まで。");
        JLabel lbl_telephone = new JLabel("電話");
        JLabel lbl_consultantTantou = new JLabel("担当");
        JLabel lbl_stamp = new JLabel("印");
        ...
        JScrollPane scrl_content = new JScrollPane(informedContent);
