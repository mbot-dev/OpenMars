...
public class MedicalCertificateView extends Panel2 {
    ...
    private void initComponents() {
        ...
        JLabel lbl_title = new JLabel("診 断 書（フォーム）", JLabel.CENTER);
        JLabel lbl_ptName = new JLabel("氏　名");
        JLabel lbl_ptAddr = new JLabel("住　所");
        JLabel lbl_ptBD = new JLabel("生年月日");
        JLabel lbl_disease = new JLabel("傷 病 名");
        JLabel lbl_diagComment = new JLabel("上記の通り診断する。");
        JLabel lbl_sex = new JLabel("性別");
