...
public class Reply2View extends Panel2 {
    ...
    private void initComponents() {
        ...
        JLabel lbl_title = new JLabel("ご　報　告（フォーム）");
        ...
        JLabel lbl_haikei = new JLabel("拝啓");
        JLabel lbl_jikaMasumasu = new JLabel("時下ますますご清祥の段、お慶び申し上げます。");
        visited = new JTextField(10);
        JLabel lbl_houkokuShimasu = new JLabel("に受診されました。下記ご報告させていただきます。");
        informedContent = new JTextArea();
        informedContent.setLineWrap(true);
        JScrollPane scrl_content = new JScrollPane(informedContent);
        JLabel lbl_shoken = new JLabel("所見等");
        ...
        JLabel lbl_consultantDr = new JLabel("担当");
        JLabel lbl_stamp = new JLabel("印");
        patientName = new JTextField(10);
        patientName.setEditable(false);
        JLabel lbl_tono = new JLabel("殿（生年月日:");
        patientBirthday = new JTextField(15);
        patientBirthday.setEditable(false);
        JLabel lbl_kakkoTen = new JLabel("）、");
        JLabel lbl_keigu = new JLabel("敬具");
