...
//s.oh$
        ...
        ComponentMemory cm = new ComponentMemory(frame, new Point(x, y), new Dimension(DEFAULT_WIDTH, DEFAULT_HEIGHT), this);
    ...
    public void startStampMake() {
        ...
        Runnable awt = this::createAndShowEditorSet;
    ...
    private void createAndShowEditorSet() {
        ...
        allTrees.stream().forEach((st) -> st.addTreeSelectionListener(editors));
    ...
    public void stopStampMake() {
        ...
        Runnable awt = this::disposeEditorSet;
    ...
    private void disposeEditorSet() {
        ...
        List<StampTree> allTrees = userBox.getAllTrees();
        allTrees.stream().forEach((st) -> st.removeTreeSelectionListener(editors));
