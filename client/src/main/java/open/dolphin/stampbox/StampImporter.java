...
public class StampImporter {
    ...
    private JPanel createBrowsePane() {
        ...
        JButton cancelBtn = new JButton(buttonTextClose);
        ...
        JLabel publicLabel = new JLabel(labelTextGlobal, ClientContext.getImageIconArias("icon_world_small"), SwingConstants.CENTER);
        JLabel localLabel = new JLabel(labeltextInternal, ClientContext.getImageIconArias("icon_hospital_small"), SwingConstants.CENTER);
        JLabel importedLabel = new JLabel(labelTextImportDone, ClientContext.getImageIconArias("icon_flag_blue_small"), SwingConstants.CENTER);
        ...
        // import
        importBtn.addActionListener((ActionEvent e) -> importPublishedTree());

        // remove
        deleteBtn.addActionListener((ActionEvent e) -> removeImportedTree());

        // キャンセル
        cancelBtn.addActionListener((ActionEvent e) -> stop());
