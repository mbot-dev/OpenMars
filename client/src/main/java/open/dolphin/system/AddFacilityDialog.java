...
public class AddFacilityDialog extends JDialog implements ComponentListener, Runnable {
    ...
    public void setServerInfo(ServerInfo info) {
        boundSupport.firePropertyChange(ACCOUNT_INFO, null, info);
    }
    ...
    private void initialize() {
        ...
        try {
            ...
            StringBuilder sb;
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(ir, StandardCharsets.UTF_8))) {
                String line;
    ...
    private void connect() {
        ...
        okBtn.addActionListener((ActionEvent e) -> addFacilityAdmin());
        
        cancelBtn.addActionListener((ActionEvent e) -> close());
    ...
    class AccountInfoListener implements PropertyChangeListener {
        @Override
        public void propertyChange(PropertyChangeEvent e) {
            accountInfoOk = (Boolean)e.getNewValue();
            controlButton();
        }
    }
    ...
    class AddFacilityTask extends SwingWorker<String, Void> {
        ...
        protected String doInBackground() throws Exception {
            ...
            return sdl.addFacilityUser(user);
        }
