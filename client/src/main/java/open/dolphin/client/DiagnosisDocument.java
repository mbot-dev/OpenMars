...
//s.oh$
    ...
    private JPanel createDignosisPanel() {
        ...
        tableModel = new ListTableModel<>(columnNames, startNumRows, methodNames, columnClasses) {
        ...
        // copy
        AbstractAction copyAction = new AbstractAction(actionText) {
...
//s.oh$
        ...
        // active病名のみ表示
        AbstractAction activeAction = new AbstractAction(actionText) {
            @Override
            public void actionPerformed(ActionEvent ae) {
...
//s.oh$
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (ascend) {
            // 昇順なのでテーブルの最後へ追加する
            for (Object o : list) {
                RegisteredDiagnosisModel module = (RegisteredDiagnosisModel) o;
                module.setStartDate(today);
                tableModel.addObject(module);
                addAddedList(module);
            }
...
//s.oh^ 2014/04/08 傷病名対応
        ...
        DiagnosisPutTask task = new DiagnosisPutTask(confirmedStr, getContext(), addedDiagnosis, updatedDiagnosis, (!saveOnly) && sendDiagnosis, ddl);
//s.oh$
        task.execute();
    }
    ...
    public void getDiagnosisHistory() {
        ...
        DBTask task = new DBTask<List<RegisteredDiagnosisModel>, Void>(getContext()) {
            ...
            protected List<RegisteredDiagnosisModel> doInBackground() throws Exception {
                DocumentDelegater ddl = new DocumentDelegater();
                return ddl.getDiagnosisList(getContext().getKarte().getId(), searchFrom, activeOnly);
            }
    ...
    public void viewOrca() {
        ...
        DBTask task = new DBTask<List<RegisteredDiagnosisModel>, Void>(getContext()) {
            ...
            protected List<RegisteredDiagnosisModel> doInBackground() throws Exception {
                ...
                return dao.getActiveOrcaDisease(patientId,ascend);
            }
...
//s.oh^ 2014/11/11 傷病名送信順番の変更
                    actualList.sort(new DiagnosisSendComparator());
//s.oh$
