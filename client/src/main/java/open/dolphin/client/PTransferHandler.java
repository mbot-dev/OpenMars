...
public class PTransferHandler extends TransferHandler implements IKarteTransferHandler {
    ...
    private boolean doStampInfoDrop(StampTreeNode droppedNode) {
        ...
        try {
            ...
            if (droppedNode.isLeaf()) {
                ...
                switch (role) {
                    ...
                    case IInfoModel.ROLE_ORCA_SET:
                        ...
                        break;
                    // 病名も受け入れる
                    case IInfoModel.ROLE_DIAGNOSIS:
            ...
            // カルテのテンプレートと考える
            StampTreeNode root = (StampTreeNode) ((DefaultMutableTreeNode)droppedNode).getRoot();
...
//s.oh$
            ...
            cb.addActionListener((ActionEvent e) -> Project.setBoolean("show.diagnosis.added.message", !cb.isSelected()));
