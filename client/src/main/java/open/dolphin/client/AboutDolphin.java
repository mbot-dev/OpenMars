                    ...
                    case 14:
                        if (col==0) {
                            ...
                            if (Project.getBoolean(GUIConst.SEND_MML_IS_RUNNING)) {
                                ret = textRunning + " " + Project.getString(Project.SEND_MML_DIRECTORY);
                            } else {
                                ret = textUnderStop;
                            }
                        }
                   ...
                   case 15:
                        if (col==0) {
                            ...
                            if (Project.getBoolean(Project.KARTE_PDF_SEND_AT_SAVE)) {
                                ret = textRunning + " " + Project.getString(Project.KARTE_PDF_SEND_DIRECTORY);
                            } else {
                                ret = textUnderStop;
                            }
                        }
                    ...
                    case 16:
                        if (col==0) {
                            ...
                            if (Project.getBoolean(GUIConst.PVT_RELAY_IS_RUNNING)) {
                                String sb = textRunning + " " + Project.getString(Project.PVT_RELAY_DIRECTORY) +
                                        " " + Project.getString(Project.PVT_RELAY_ENCODING);
                                ret = sb;
                            } else {
                                ret = textUnderStop;
                            }
