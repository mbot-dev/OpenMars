...
public final class KartePaneDumper_2 {
    ...
    public ModuleModel[] getModule() {
        ...
        if ((moduleList != null) && (moduleList.size() > 0)) {
            ret = moduleList.toArray(new ModuleModel[0]);
        }
        return ret;
    }
    ...
    public SchemaModel[] getSchema() {
        ...
        if ((schemaList != null) && (schemaList.size() > 0)) {
            ...
            schemas = schemaList.toArray(new SchemaModel[0]);
        }
        return schemas;
    }
    ...
    public AttachmentModel[] getAttachment() {
        ...
        if ((attachmentList != null) && (attachmentList.size() > 0)) {
            ...
            ret = attachmentList.toArray(new AttachmentModel[0]);
        }
        return ret;
    }
...
//s.oh$
                    ...
                    if (nextName.toString().equals("foreground")) {
                        ...
                        String buf = String.valueOf(c.getRed()) +
                                "," +
                                c.getGreen() +
                                "," +
                                c.getBlue();
