...
public class PhysicalEditor {
    ...
    public PhysicalEditor(PhysicalInspector inspector) {
        ...
        // Return で移動
        view.getHeightFld().addActionListener((ActionEvent ae) -> view.getWeightFld().requestFocus());
        
        view.getWeightFld().addActionListener((ActionEvent ae) -> view.getIdentifiedDateFld().requestFocus());
