...
public class CalendarCardPanel extends JPanel  {
    ...
    public CalendarCardPanel(HashMap colorTable) {
        ...
        titleLable.setHorizontalAlignment(TITLE_ALIGN);
        titleLable.setFont(TITLE_FONT);
        Color titleFore = ClientContext.getColor("color.calendar.title.fore");
        titleLable.setForeground(titleFore);
        Color titleBack = ClientContext.getColor("color.calendar.title.back");
