...
public class ColorChooserComp extends JComponent implements MouseListener, MouseMotionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i=0; i < colors.length; i++) {
            ...
            Ellipse2D.Double body = new Ellipse2D.Double(x, offsetY, size.getWidth(), size.getHeight());
            GradientPaint lightToDark = new GradientPaint((int)x, (int) offsetY, colorStart[i], (int)x + size.width, (int) offsetY + size.height, colors[i]);
