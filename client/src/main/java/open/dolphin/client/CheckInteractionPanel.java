...
public class CheckInteractionPanel {
    ...
    private void showDialog(){
        ...
        if (rirekiItems!=null) {
            ...
            lbl_Past_count.setText(bundle.getString("totalKindsOfMedication") + cnt);
        }
        dialog = new JDialog(context.getFrame(), true);
        ...
        // dialogのタイトルを設定
        String sb = context.getPatient().getFullName() +
                "(" +
                context.getPatient().getKanaName() +
                ") : " +
                context.getPatient().getPatientId() +
                bundle.getString("contraindicationsSearch");
        dialog.setTitle(ClientContext.getFrameTitle(sb));
        dialog.pack();
    ...
    private void searchTask() {
        ...
        // 検索にマッチした薬剤
        HashMap<String, String> kensakuItems = new HashMap<>();
    ...
    private void initComponents() {
        ...
        JLabel lbl_Info = new JLabel(bundle.getString("checkPast3monthOfMedicationANdContradication"));
        lbl_Past_count = new JLabel(bundle.getString("numMedications"));
        JLabel lbl_Name = new JLabel(bundle.getString("medicineName"));
        JLabel lbl_Result = new JLabel(bundle.getString("results"));
        keywordFld = new JTextField();
        JButton btn_Exit = new JButton(bundle.getString("quit"));
        JButton btn_Search = new JButton(bundle.getString("search"));
        ...
        btn_Search.addActionListener((ActionEvent e) -> search());
        btn_Exit.addActionListener((ActionEvent e) -> closePanel());
        
        keywordFld.addFocusListener(AutoKanjiListener.getInstance());
        keywordFld.addActionListener((ActionEvent e) -> search());
    }
}
