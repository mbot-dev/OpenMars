...
//s.oh$
                    ...
                    case TT_SHINKU_SERACH:
                        ...
                        String sb = "^" +
                                shin.substring(1);
                        result = dao.getTensuMasterByShinku(sb, d);
                        break;
                }
    ...
    private void getPart() {
        ...
        SwingWorker worker = new SwingWorker<List<TensuMaster>, Void>() {
            ...
            protected List<TensuMaster> doInBackground() throws Exception {
                ...
                OrcaDelegater dao = OrcaDelegaterFactory.create();
                String d = new SimpleDateFormat("yyyyMMdd").format(new Date());
                return dao.getTensuMasterByCode("002", d);
            }
    ...
    private void initComponents() {
        ...
        // カラム幅
        int[] COLUMN_WIDTH = new int[]{50, 200, 10, 10};
        ...
        // カラム幅
        int[] SR_COLUMN_WIDTH = new int[]{10, 50, 200, 10, 10, 10, 5, 5, 5};
...
//s.oh$
        ...
        // 部位検索ボタン
        view.getPartBtn().addActionListener((ActionEvent e) -> getPart());
