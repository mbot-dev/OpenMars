...
public class EditorSetPanel extends JPanel implements PropertyChangeListener, TreeSelectionListener {
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (prop.equals(AbstractStampEditor.VALIDA_DATA_PROP)) {
            ...
            boolean setIsEmpty = (Boolean) e.getNewValue();
    ...
    private void connect() {
        ...
        // 取り込みボタン　左矢印
        //--------------------------------------------------
        leftImport.addActionListener(ae -> {
    ...
    private void initComponent() {
        ...
        AbstractStampEditor baseCharge = new BaseEditor(IInfoModel.ENTITY_BASE_CHARGE_ORDER, false);
        diagnosis = new DiseaseEditor(false);
        AbstractStampEditor general = new BaseEditor(IInfoModel.ENTITY_GENERAL_ORDER, false);
        AbstractStampEditor injection = new InjectionEditor(IInfoModel.ENTITY_INJECTION_ORDER, false);
        AbstractStampEditor instraction = new BaseEditor(IInfoModel.ENTITY_INSTRACTION_CHARGE_ORDER, false);
        AbstractStampEditor med = new RpEditor(IInfoModel.ENTITY_MED_ORDER, false);
        AbstractStampEditor other = new BaseEditor(IInfoModel.ENTITY_OTHER_ORDER, false);
        physiology = new BaseEditor(IInfoModel.ENTITY_PHYSIOLOGY_ORDER, false);
        AbstractStampEditor radiology = new RadEditor(IInfoModel.ENTITY_RADIOLOGY_ORDER, false);
        AbstractStampEditor surgery = new BaseEditor(IInfoModel.ENTITY_SURGERY_ORDER, false);
        test = new BaseEditor(IInfoModel.ENTITY_LABO_TEST, false);
        AbstractStampEditor treatment = new BaseEditor(IInfoModel.ENTITY_TREATMENT, false);
