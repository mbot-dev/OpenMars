...
////s.oh$
    ...
    public Object getValue() {
        ...
        // 院内処方 or 院外処方
        int inExt = view.getInRadio().isSelected() ? 1 : 2;
    ...
    private void getUsage(final String regExp) {
        ...
        SwingWorker worker = new SwingWorker<List<TensuMaster>, Void>() {
            ...
            protected List<TensuMaster> doInBackground() throws Exception {
                ...
                return dao.getTensuMasterByCode(regExp, d);
            }
...
//s.oh$
    ...
    private void initComponents() {
        ...
        // カラム幅等
        int[] COLUMN_WIDTH = new int[]{50, 200, 10, 10, 10};
        ONEDAY_COLUMN = 2;
        BUNDLE_COLUMN = 5;

        // マスターテーブルのカラム名
        line = bundle.getString("columnNames.masterTable");
        String[] SR_COLUMN_NAMES = line.split(",");

        // マスターテーブルのMethod名
        line = bundle.getString("methods.masterTable");
        String[] SR_METHOD_NAMES = line.split(",");

        // カラム幅等
        int[] SR_COLUMN_WIDTH = new int[]{10, 50, 200, 10, 10, 10};
        int SR_NUM_ROWS = 20;
        ...
        // セットテーブルを生成する
        tableModel = new ListTableModel<>(COLUMN_NAMES, 0, METHOD_NAMES, null) {
...
//s.oh$
        ...
        searchTextField.addActionListener((ActionEvent e) -> search(view.getSearchTextField().getText().trim(),true));
        ...
        view.getRtCheck().addActionListener((ActionEvent arg0) -> Project.setBoolean("masterSearch.realTime", view.getRtCheck().isSelected()));

        // 部分一致
        boolean pmatch = Project.getBoolean("masterSearch.partialMatch", false);
        view.getPartialChk().setSelected(pmatch);
        view.getPartialChk().addActionListener((ActionEvent arg0) -> Project.setBoolean("masterSearch.partialMatch", view.getPartialChk().isSelected()));
...
////s.oh$      
        ...
        view.getClearBtn().addActionListener((ActionEvent e) -> clear());
    }
