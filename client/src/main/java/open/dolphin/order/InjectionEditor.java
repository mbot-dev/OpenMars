...
////s.oh$
        ...
        searchResultModel = new ListTableModel<>(SR_COLUMN_NAMES, 0, SR_METHOD_NAMES, null) {
...
//s.oh$
        ...
        view.getRtBtn().addActionListener((ActionEvent arg0) -> Project.setBoolean("masterSearch.realTime", view.getRtBtn().isSelected()));
